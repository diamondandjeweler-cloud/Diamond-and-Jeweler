...
{profile?.role === 'talent' && profile?.points != null && (
              <Link to="/points" className="hidden sm:inline-flex items-center gap-1.5 text-xs px-2 py-1 rounded-full bg-accent-500/10 text-accent-700 ring-1 ring-accent-500/20 hover:bg-accent-500/15">
      ...
      <main id="main-content" className="flex-1 max-w-7xl w-full mx-auto px-4 md:px-6 py-8 md:py-10 dark:bg-navy-900" role="main">
        <Outlet />
      </main>
