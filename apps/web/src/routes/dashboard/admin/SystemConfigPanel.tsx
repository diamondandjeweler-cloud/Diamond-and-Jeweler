    ...
    <div>
      ...
      <div className="space-y-4">
        {rows.map((r) => {
          ...
          return (
            <div key={r.key} className="bg-surface border dark:border-border rounded p-4">
              <div className="flex justify-between items-start">
                <div>
                  <code className="text-sm font-semibold dark:text-fg">{r.key}</code>
                  {secret && (
              ...
              {secret ? (
                ...
                <textarea
                  ...
                  className="w-full border dark:border-border rounded px-3 py-2 mt-2 font-mono text-xs"
                  spellCheck={false}
