...
// Hard gate: zero critical/serious axe violations on every public/auth page.
// The onboarding form-label + autofocus issues that previously forced a
// soft-warning have been fixed, so this suite now blocks on any regression.
