...
COVERS = [
    ...
    # —— 案例系列扩展 case5-8 ——
    ("cover-case5",  "璞玉案例 05", ["教师 8 年", "→ EdTech offer", "薪水 +40%"], [1]),
    ("cover-case6",  "璞玉案例 06", ["单亲妈妈 2 娃", "→ 远程 +RM1,800"], [1]),
    ("cover-case7",  "璞玉案例 07", ["设计师", "→ AI Prompt", "RM3.2K → 6.5K"], [2]),
    ("cover-case8",  "璞玉案例 08", ["45 岁制造业", "→ ESG 顾问", "起薪 +20%"], [1]),
]
