    ...
    <div>
      <div className="flex gap-2 mb-4">
        <input
          ...
          className="border dark:border-border rounded px-3 py-1.5 text-sm flex-1"
          aria-label="Search users"
        />
        <select
          value={filter}
          onChange={(e) => setFilter(e.target.value as typeof filter)}
          className="border dark:border-border rounded px-2 py-1.5 text-sm"
      ...
      {changeRoleModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-surface rounded-xl shadow-xl p-6 w-full max-w-sm space-y-4">
            <h3 className="font-semibold text-base dark:text-fg">Change role — {changeRoleModal.name}</h3>
            ...
            <div>
              ...
              <select
                ...
                className="w-full border dark:border-border rounded-lg px-3 py-2 text-sm"
              >
                {ROLE_OPTIONS.map((o) => (
