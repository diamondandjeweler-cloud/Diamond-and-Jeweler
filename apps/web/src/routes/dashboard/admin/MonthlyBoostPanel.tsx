...
export default function MonthlyBoostPanel() {
  ...
  return (
    <div className="max-w-md space-y-6">
      <div>
        <h2 className="text-sm font-semibold text-fg mb-1">Monthly character boost</h2>
      ...
      {checking ? (
        ...
        <div className="rounded-lg border border-border bg-gray-50 dark:bg-surface px-3 py-2.5 text-xs text-fg-muted">
      ...
      <div>
        <p className="text-xs font-medium text-fg-muted mb-2">
          ...
          <span className={selected.length >= 3 ? 'text-amber-600' : 'text-fg-subtle'}>
            ({selected.length}/3)
          </span>
        </p>
