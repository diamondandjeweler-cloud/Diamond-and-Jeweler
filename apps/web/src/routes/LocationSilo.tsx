...
import { LOCATIONS, ROLES, type LocationSlug } from '../shared/content/silo-data'
...
export default function LocationSilo() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-navy-900 text-navy-900 dark:text-fg font-sans">
