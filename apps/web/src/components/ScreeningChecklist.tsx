  ...
  return (
    <div className="mt-3 border border-border rounded-lg overflow-hidden">
      ...
      >
        ...
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className={`transition-transform text-fg-subtle ${open ? 'rotate-180' : ''}`} aria-hidden>
      ...
      {open && (
        <div className="p-3 space-y-2">
          <p className="text-xs text-fg-muted mb-3">Auto-generated from platform signals. Tick off as you go.</p>
          {items.map((item, i) => (
